...
<p>At conferences and other events, the Foundation may hand out ribbons or tags that members can wear with their conference credentials. These are given only to people whose membership the Foundation has verified. The Foundation also issues each member a badge image stamped with their member number, delivered with the welcome email, which you may display on a website, a profile, or a business card. The badge signifies membership, not any certification or endorsement by the Foundation. Display it as issued, and do not make your own badge or other graphic using the Foundation&rsquo;s logo or marks.</p>
