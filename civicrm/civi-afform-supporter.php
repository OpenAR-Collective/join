...
<p><strong>Listing on the public roster.</strong> The Foundation will list your organization by name on the Mission Supporter roster on its website, with a link to your website if you provide one. The roster carries no logos, so that it reads as a list of the organizations that support the mission rather than as advertising. All organizations appear on identical terms, in alphabetical order, with no tiers and no indication of who has contributed financially.</p>
