...
<p><strong>Listing on the public roster.</strong> The Foundation will list your organization by name on the Mission Supporter roster on its website, with a link to your website if you provide one. The roster is a plain list of names. The Foundation does not display logos, taglines, product names, or promotional material there. All organizations appear on identical terms, in alphabetical order, with no tiers and no indication of who has contributed financially.</p>
...
<p>At conferences and other events, the Foundation may hand out ribbons or tags for your representatives to wear with their conference credentials. The Foundation issues Mission Supporters a badge image, delivered with the listing confirmation, which your organization may display on its website or in its materials alongside the designation. The badge signifies your organization’s statement of support, not any certification, approval, or endorsement by the Foundation. Your organization will display the badge as issued and will not make its own badge or other graphic using the Foundation’s logo or marks.</p>
